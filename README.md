...
```
LeetCoding/
├── questions/                  # LeetCode题目原文（按学习模块/专题分类）
│   ├── 00初生牛犊不怕虎/
│   │   ├── 1. 两数之和.md
│   │   ├── 20. 有效的括号.md
│   │   └── ...
...
│       ├── 3.哈希/
│       └── 4.设计/
├── answers/                    # 题目代码实现（与 questions 同结构）
├── analysis/                   # 题目思路分析（与 questions 同结构）
├── leetcode-analyze-skill/     # AI辅助分析Skill
│   ├── SKILL.md
│   ├── assets/
│   └── references/
├── GEMINI.md                   # Gemini CLI系统提示词
...
# 在对话中请求分析
"请使用leetcode-analyze-skill分析 questions/.../1. 两数之和.md"
```
